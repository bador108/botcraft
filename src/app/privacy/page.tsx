...
export const metadata = { title: 'Ochrana soukromí — BotCraft' }
  ...
  return (
    <div className="min-h-screen bg-bone">
      ...
      <div className="max-w-2xl mx-auto px-5 md:px-8 py-16 md:py-24">
        ...
        <h1 className="text-4xl font-bold text-ink tracking-tight mb-3">Ochrana soukromí</h1>
        ...
        <div className="border border-paper_border border-dashed bg-paper rounded-xl p-8 text-center">
          <p className="text-sm text-muted">Zásady ochrany soukromí jsou připravovány. Kontaktuj nás na <a href="mailto:hello@botcraft.app" className="text-rust hover:text-rust_hover">hello@botcraft.app</a>.</p>
        </div>
        <div className="mt-10">
